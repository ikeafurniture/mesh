var App = React.createClass({
  ...
  render: function render() {
    return (
      React.createElement(PeerList, React.createElement(FileList, null))
...
var FileList = React.createClass({displayName: "FileList",
  ...
  render: function() {
    var files = this.state.files.map(function(file, index) {
        return React.createElement(File, {Name: file.name}); // Size, icon, what else?
    });
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "file"}, 
        React.createElement("h2", null, this.props.FileName)
      )
    );
  }
})
